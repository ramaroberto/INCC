...
\begin{abstract}Desde tiempos inmemoriables las personas han expresado variados gustos y opiniones sobre distintos topicos, siendo la literatura uno de los mas discutidos. Los fundamentos de las opiniones pueden ser muy variados e incluso difusos para los dueños de las mismas. A pesar de esto las personas son capaces de asignar un puntaje numerico comparativo a una obra, que dado un numero grande de puntajes tiende a converger a un numero, evidenciando asi una especie de acuerdo en el gusto general. Estos sistemas de puntajes son normalmente utilizados por las tiendas online, como una forma de guia confiable para otros clientes, pero ademas son una fuente de informacion muy interesante. En el presente trabajo practico ponemos a prueba la hipotesis de que la forma de escritura de un libro influye en la recepcion del mismo por la poblacion, siendo libros mas legibles mejor valorados. Demostramos la validez de esta hipotesis analizando distintas metricas de legibilidad clasicas en una fraccion de los libros de la base de datos de Amazon, asegurando cierta homogeneidad en la seleccion de los mismos utilizando sus categorias.
\end{abstract}
...
siendo $\alpha$ = 0.001 el nivel de significancia del test.
