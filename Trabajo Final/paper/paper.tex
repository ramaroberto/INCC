...
En primer lugar, en la sección Métricas\ref{metricas}, se explican las métricas utilizadas para medir la legibilidad de los textos: ARI, Coleman-Liau Index, Flesch–Kincaid, SMOG, Dale–Chall y Lix. Luego, en la sección Análisis del dataset\ref{analisisdeldataset}, se detallan los tratamientos y filtrados aplicados a la base de datos utilizada para la experimentación. Por otro lado, se presenta un amplio análisis de las reseñas y las categorías que se tuvieron en cuenta a la hora de realizar el filtrado y clusterización correspondientes para la posterior experimentación. Por otra parte, en la sección Experimentos y resultados\ref{expyres}, se exponen los gráficos resultantes de evaluar los libros con las métricas, así como también el planteo y los resultados del test de hipótesis utilizado para probar la veracidad de los mismos. Por último, en la sección Conclusiones y trabajo futuro\ref{conclusion}, se presenta un amplio espectro de posibilidades para trabajar sobre el tema presentado a futuro, así como también las conclusiones extraídas del trabajo realizado.
...
\begin{figure}[H]
\begin{center}
  \includegraphics[width=5.0in]{../unigrams/scripts/histogram/histogramaDePalabras.png}
